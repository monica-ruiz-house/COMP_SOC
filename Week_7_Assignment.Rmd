...
1.  Load in the New York Times and Breitbart text files that we used for last week's assignment. Combine the two data frames using the row bind function "rbind()" so that they are in the same dataframe. Remove stopwords using the script included below. Assign each article a unique article number.
