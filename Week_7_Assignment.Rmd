...
# Since we will later be be merging by row, need to distinguish between NYT & breitbart
...
# Remove stopwords:
  # I have replaced the provided script with my own
  # (previous script wasn't converted back to character type)
clean_nytimes <- nytimes %>%
  unnest_tokens(word, article) 

# Merge  both dataframes together with rbind
merged_df <- rbind(clean_nytimes, clean_breitbart)
```
